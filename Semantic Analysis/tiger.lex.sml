...
fun yyAction42 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.STRING(stringWithoutQuotes(yytext), yypos, yypos + size yytext))
      end
       ...
       of NONE => yyAction40(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction40(strm, yyNO_MATCH)
                  else yyQ49(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
              else yyAction40(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction40(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction40(strm, yyNO_MATCH)
                  else yyQ82(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
              else yyAction40(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ91(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
